...
\hypertarget{cuando-queremos-hacer-la-rauxedz-cuadrada-de-2-podemos-en-la-misma-luxednea}{%
\subsubsection{Cuando queremos hacer la raíz cuadrada de 2, podemos en
la misma
línea:}\label{cuando-queremos-hacer-la-rauxedz-cuadrada-de-2-podemos-en-la-misma-luxednea}}
...
El numero \(\pi\) empieza por 3.1415927

La raiz quinta de 32 es 2, otra forma es \(\sqrt[5]{32}= r 32^(1/5)\)

Este ano he hecho \(n=6\) examenes, con una media \(\overline{x}=\) 6.83
y una desviacion tipica de \(s=\) 2.56
